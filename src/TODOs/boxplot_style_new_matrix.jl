...
push!(logo_paths_here_sorted, "")
push!(contribs_here_sorted, Vector{float_type}())
...
# save("cross_results/singletons.png", fig; px_per_unit=2)

save("yeast_result/singletons.png", fig; px_per_unit=2)